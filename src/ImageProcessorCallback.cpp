...
void    AquabotNode::_qrDetector(cv::Mat & frame) {
...
void    AquabotNode::_obstacleDetector(cv::Mat & frame) {
...
void    AquabotNode::_imageProcessorCallback(void) {
